...
##net.SGD(training_data, 30, 10, 3.13, validation_data = validation_data)
##test_data = list(test_data)
##total_test = len(test_data)
##results = 100.0 * net.evaluate(test_data, convert=True)/total_test
...
net.SGD(training_data, 2, 10, 0.4,
        reg_param = 5.0,
